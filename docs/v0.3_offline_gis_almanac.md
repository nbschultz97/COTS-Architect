# Ceradon Architect v0.3: Offline GIS & Environmental Intelligence
...
### **IndexedDB Databases:**
```
ceradon_srtm_tiles              // Elevation data
ceradon_environment_almanac     // Climate regions
ceradon_parts_library           // COTS components
ceradon_mission_projects        // Mission data
```

### **LocalStorage Keys:**
```
ceradon_platform_designs        // Platform configurations
ceradon_mission_plans           // Mission plans
ceradon_comms_analyses          // RF analyses
ceradon_map_locations           // Last map view
ceradon_elevation_cache         // Elevation query cache
```
